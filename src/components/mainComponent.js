...
const mapDispatchToProps = (dispatch) => ({
  ...
  postFeedback: (nombre, apellido, telefono, email, aprueba, tipoContacto, mensaje) => dispatch(
    postFeedback(nombre, apellido, telefono, email, aprueba, tipoContacto, mensaje)),
